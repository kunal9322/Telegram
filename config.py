...
class Config(object):
    ...
    TOKEN = getenv("TOKEN", "6221284663:AAFwRX9OMm_22LQUiBKzVbJ1bimdbuZPLEU")
    ...
    ALLOW_EXCL = True
    CUSTOM_CMD = False
    CASH_API_KEY = getenv("CASH_API_KEY", "PRPSG4AY3Q3H0QG0")
    TIME_API_KEY = getenv("TIME_API_KEY", "S3J6EISOC17L")
